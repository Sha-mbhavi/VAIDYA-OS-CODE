...
export function InteractiveFolder({ 
  color = '#1E40AF', // Dark blue default
  size = 1, 
  items = [], 
  className = '',
  label
      ...
      >
        ...
        <div
          ...
          style={{ 
            ...
            boxShadow: isOpen ? '0 10px 30px -5px rgba(0,0,0,0.4)' : '0 4px 12px -2px rgba(0,0,0,0.2)'
          }}
        >
          {/* Tab */}
          <div
          ...
          {displayItems.map((item, i) => (
            <motion.div
              ...
              className="absolute left-1/2 flex items-center justify-center overflow-hidden text-black"
              style={{
                zIndex: 20,
